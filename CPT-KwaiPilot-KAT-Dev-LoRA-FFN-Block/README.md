# Hyperswitch CPT Training - KAT-Dev-32B-LoRA-FFN-Block
...
- **Method**: LoRA (Low-Rank Adaptation, r=64, alpha=128, Only FFN Block - gate_proj, up_proj, down_proj)
...
- **Batch size**: 8 micro × 4 grad_accum × 2 GPUs = 64 effective
- **Learning rate**: 1e-4 with cosine schedule, warmup=0.03
- **Epochs**: 2
...
- Total steps: ~940 (2 epochs)
- ~5-6 seconds per step
- **Total: ~1.5-2 hours** on 2x H200
...
```yaml
training:
  learning_rate: 0.0001     # Try lower (was 1e-4)
```
