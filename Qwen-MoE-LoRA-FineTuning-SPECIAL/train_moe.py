...
class MoEFineTuner:
    ...
    def create_trainer(self):
        ...
        def compute_metrics(eval_pred):
            ...
            # The loss is already computed by the model
            # We'll compute perplexity from the eval_loss in the callback
            return {}
        
        # Custom callback to log perplexity
        from transformers import TrainerCallback
        
        class PerplexityCallback(TrainerCallback):
            """Callback to compute and log perplexity"""
        ...
        self.trainer = Trainer(
            ...
            callbacks=[perplexity_callback] if self.config['validation'].get('compute_perplexity', True) else [],
        )
